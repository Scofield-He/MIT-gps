...
$Id: globalDownload.py 6116 2017-06-21 14:33:21Z brideout $
"""
...
def getExperimentFileList(server, expList, includeNonDefault):
...
expFileList = getExperimentFileList(server, expList, includeNonDefault)
